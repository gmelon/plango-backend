...
class NotificationTypeTest {
    ...
    void 전달한_인자들이_title_문자열에_포맷팅된다() {
        ...
        // when
        String formattedTitle = dev.gmelon.plango.domain.notification.entity.type.TestNotificationType.SCHEDULE_INVITED.formatTitle(titleArguments);
    ...
    void 전달한_인자들이_content_문자열에_포맷팅된다() {
        ...
        // when
        String formattedContent = dev.gmelon.plango.domain.notification.entity.type.TestNotificationType.SCHEDULE_INVITED.formatContent(contentArguments);
    ...
    void NotificationArguments를_통해_알림_타입별로_포맷팅_인자를_받을_수_있다() {
        ...
        // when
        NotificationType.NotificationArguments notificationArguments = NotificationType.NotificationArguments.builderOf(
                        dev.gmelon.plango.domain.notification.entity.type.TestNotificationType.SCHEDULE_INVITED)
    ...
    void NotificationArguments에_전달된_titleArgument_개수가_알림_타입과_맞지_않으면_예외가_발생한다() {
        ...
        // when, then
        assertThatThrownBy(
                () -> NotificationType.NotificationArguments.builderOf(
                                dev.gmelon.plango.domain.notification.entity.type.TestNotificationType.SCHEDULE_INVITED)
                        .contentArgument(contentArgument1)
                        .contentArgument(contentArgument2)
                        .build()
