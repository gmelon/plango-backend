...
create table schedule (id bigint not null auto_increment, created_time timestamp, modified_date timestamp, content TEXT, done BOOLEAN DEFAULT 0 not null, end_time timestamp not null, location varchar(255), start_time timestamp not null, title varchar(255) not null, diary_id bigint, member_id bigint, primary key (id));
